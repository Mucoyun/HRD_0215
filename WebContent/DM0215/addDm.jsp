	...
	<script>
		function gotry() {
			if(document.iu_form.custid.value == ""){
				...
				document.iu_form.action = "addDm_process.jsp";
...
<body>
	...
	%>
	<section>
		<h2>dm 정보 등록 화면</h2><hr>
		<form name="iu_form" method="post" action="addDm.jsp">
			<table id="iu_table">
				<tr>
					<th>dm 발송번호</th>
					<td colspan="3"><input class="text_l" type="text" name="dmno" value="<%=dmno %>" readonly>마지막번호+1</td>
				</tr>
				<tr>
					<th>고객아이디</th>
